...
const Members = [
        ...
        "result":[
            ...
            new RaceResultObj(4, 6, 1, 3, 2, 1402, ["UE3", 30507], "差し", "好調", 900, [], 0, "-", ["", ""],
                new RaceResultStatusObj(
                    ...
                    "直線回復", "ノンストップガール","昇りコンドル", "豪勇無双", "先行ためらい", "マイル直線〇", "マイルコーナー〇", "アクセラレーション",
    ...
    },
    {
        ...
        "result":[
            ...
            new RaceResultObj(4, 5, 2, 1, 1, "ミスターシービー", ["UE2", 30354], "追込", "絶好調", 0, [], 0, "2", 0, ["", ""],
                new RaceResultStatusObj(
    ...
    },
    {
        ...
        "result":[
            ...
            new RaceResultObj(
                4, 2, 1, 2, 1, "タイキシャトル", ["UF7", 32813], "先行", "好調", 1412, [], 0, "-", 0, [], 
                new RaceResultStatusObj(
    ...
    },
    {
        ...
        "result":[
            ...
            new RaceResultObj(
                4, 11, 0, 0, 0, "ダイタクヘリオス", ["UE4", 31226], "先行", "絶好調", 0, [], 0, "-", 0, [],
            ...
            new RaceResultObj(
                4, 1, 1, 6, 1, "ダイタクヘリオス", ["UE4", 31226], "先行", "絶好調", 901, [], 0, "-", 0, [],
                new RaceResultStatusObj({"Speed":1533,"Stamina":740,"Power":1379,"Guts":1382,"Intelligent":1204}, {"Feald":"A","Length":"S","Strategy":"A",},
                    ["アゲてアゲてぷちょへんざ！", "アングリングxスキーミング", "つぼみ、ほころぶ時", "根幹距離〇", "先行のコツ〇", "自信家", "積極策", "地固め", "序盤巧者", "マジ爆上げっしょ！", "尻尾上がり",
                    "とりまやったれ～！", "しとやかな足取り", "鍔迫り合い", "ハイボルテージ", "弧線のプロフェッサー", "直線巧者", "マイル直線〇", "マイルコーナー〇", "負けん気","お先に失礼っ！", "あやしげな作戦"])
            ),
    ...
    },
    {
        ...
        "result":[
            ...
            new RaceResultObj(4, 8, 1, 3, 1, "バンブーメモリー(2)", ["UE2", 30068], "差し", "普通", 915, [], 0, "-", 0, ["", ""],
                new RaceResultStatusObj(
    ...
    },
    {
        ...
        "result":[
            ...
            new RaceResultObj(4, 9, 2, 7, 2, "マルゼンスキー(1)", ["UF4", 26197], "逃げ", "普通", 0, [], 0, "大差", 0, ["", ""],
                new RaceResultStatusObj(
    ...
    },
    {
        ...
        "result":[
            ...
            new RaceResultObj(4, 7, 1, 9, 1, "アグネスタキオン", ["UE4", 31184], "先行", "好調", 1174, [], 0, "-", ["", ""],
                new RaceResultStatusObj(
